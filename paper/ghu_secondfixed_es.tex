...
identidad sea cierta, y alcanza la factorizaci\'on y no s\'olo la anulaci\'on. Lo que
...
o cero, y --- este es el punto en el que merece la pena detenerse --- \textbf{no hay hip\'otesis
...
nada; otra familia de alfabetos\\
\midrule
\rowcolor{softgrey}
...
\eqref{eq:closedform}, ni encontramos enunciado alguno del criterio de anulaci\'on para este
alfabeto.
