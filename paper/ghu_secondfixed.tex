...
reaches the factorisation and not only the vanishing. What we take to be the result of this
...
So the character is always $\pm$ a product of exactly three $SU(2)$ characters, or zero, and
...
nothing; a different alphabet family\\
\midrule
\rowcolor{softgrey}
...
Albion,Karmakar}, and Littlewood's book Ch.~XI. We did not find \eqref{eq:closedform}, and we
did not find any statement of the vanishing criterion for this alphabet.
